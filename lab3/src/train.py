...
def get_args():
    ...
    #& C:/Users/darren/miniconda3/envs/plzcuda/python.exe c:/Users/darren/Documents/大學作業/深度/lab3/Lab3_Binary_Semantic_Segmentation/src/train.py -e 5 -b 8 -lr 0.001
...
if __name__ == "__main__":
    ...
    endless_mode=True
    ###
    dataloader,num_batch=load_dataset(data_path="dataset/oxford-iiit-pet", mode="train", batchsize=args.batch_size)
    if endless_mode:
        for i in range(1000):
