...
def load_dataset(data_path, mode, batchsize):
    ...
    dataloader=torch.utils.data.DataLoader(dataset, batch_size=batchsize, shuffle=(mode=="train"))
...
def test_for_dataset():
    dataloader,num_batch = load_dataset(data_path="dataset", mode="train", batchsize=128)
